...
downloaded at \texttt{http://projects.hepforge.org/superchic/} and at 
\texttt{https://github.com/LucianHL/SuperChic}. To 
...
Since the version 5.0 the recommended way to build the sources id to use \texttt{CMake}
...
Please note that during the test phase it is recommended to use the \texttt{-DSUPERCHIC\_DOWNLOAD\_PDFS=ON/OFF} so the 
corresponding PDFs needed in the test will be installed automatically.
