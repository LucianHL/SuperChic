...
\title{SuperChic v4.2 : \\ \vspace{0.5cm}A Monte Carlo for Central Exclusive Production}
...
{\huge SuperChic v4.2} \\ \vspace{0.5cm} {\Large A Monte Carlo for Central Exclusive Production}
