...
C     
      INTEGER USERHEL
      COMMON/HELUSERCHOICE_ad/USERHEL
      DATA USERHEL/-1/
      LOGICAL HELRESET_AD
      COMMON/HELRESET_AD/HELRESET_AD
      DATA HELRESET_AD/.TRUE./
      ...
      COMMON/BORN_BEAM_POL_ad/POLARIZATIONS
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=MATRIX_AD(P ,NHEL(1,IHEL),JC(1))
     ...
     $        THEN
      ...
      REAL*8 FUNCTION MATRIX_AD(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.1.1, 2021-05-28
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV2_1(W(1,3),W(1,4),GC_100,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,6),W(1,7),W(1,5),GC_100,AMP(1))
      CALL VVV1P0_1(W(1,5),W(1,4),-GC_3,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,3),W(1,8),GC_1,AMP(2))
      CALL VVV1_3(W(1,5),W(1,4),GC_53,MDL_MZ,MDL_WZ,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,6),W(1,3),W(1,9),GC_50,GC_58,AMP(3))
      CALL FFV1_1(W(1,3),W(1,1),GC_1,ZERO,ZERO,W(1,6))
      CALL FFV2_2(W(1,2),W(1,5),GC_100,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,10),W(1,6),W(1,4),GC_100,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,6),W(1,8),GC_1,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,2),W(1,6),W(1,9),GC_50,GC_58,AMP(6))
      CALL VVV1_2(W(1,1),W(1,4),-GC_3,MDL_MW,MDL_WW,W(1,6))
      CALL FFV1P0_3(W(1,2),W(1,3),GC_1,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 7
      CALL VVV1_0(W(1,9),W(1,5),W(1,6),-GC_3,AMP(7))
      CALL FFV2_3_3(W(1,2),W(1,3),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,8))
C     Amplitude(s) for diagram number 8
      CALL VVV1_0(W(1,5),W(1,6),W(1,8),GC_53,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,10),W(1,3),W(1,6),GC_100,AMP(9))
...
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,2),W(1,7),W(1,6),GC_100,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,10),W(1,7),W(1,1),GC_2,AMP(13))
      CALL VVVV2P0_1(W(1,1),W(1,5),W(1,4),GC_5,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,2),W(1,3),W(1,10),GC_1,AMP(14))
      CALL VVVV5_4(W(1,1),W(1,5),W(1,4),GC_57,MDL_MZ,MDL_WZ,W(1,10))
C     Amplitude(s) for diagram number 15
      CALL FFV2_3_0(W(1,2),W(1,3),W(1,10),GC_50,GC_58,AMP(15))
     ...
     $        +AMP(9)+AMP(10)+AMP(11)+AMP(12)+AMP(13)+AMP(14)+AMP(15)
      ...
      elseif(wpol.eq.'tran')then
         if(nhel(5).eq.0)matrix_ad=0d0
         if(nhel(4).eq.0)matrix_ad=0d0
      elseif(wpol.eq.'long')then
         if(nhel(5).eq.1)matrix_ad=0d0
         if(nhel(4).eq.1)matrix_ad=0d0
         if(nhel(5).eq.-1)matrix_ad=0d0
         if(nhel(4).eq.-1)matrix_ad=0d0
      endif
