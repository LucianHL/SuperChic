...
C     
C     Process: u d~ > u d~ w+ w- QCD=0 @10
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      INTEGER USERHEL
      COMMON/HELUSERCHOICE_udb/USERHEL
      DATA USERHEL/-1/
      LOGICAL HELRESET
      COMMON/HELRESET_udb/HELRESET
      DATA HELRESET/.TRUE./
      ...
      COMMON/BORN_BEAM_POL_udb/POLARIZATIONS
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=MATRIX_UDB(P ,NHEL(1,IHEL),JC(1))
     ...
     $        THEN
      ...
      REAL*8 FUNCTION MATRIX_UDB(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.1.1, 2021-05-28
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
c      CALL FFV2_3t(W(1,1),W(1,2),GC_100,MDL_MW,MDL_WW,W(1,7))
      CALL FFV2_3(W(1,4),W(1,3),GC_100,MDL_MW,MDL_WW,W(1,8))
C     Amplitude(s) for diagram number 1
      CALL VVVV2_0(W(1,7),W(1,6),W(1,8),W(1,5),GC_35,AMP(1))
c      CALL VVVV2_0_t(W(1,7),W(1,6),W(1,8),W(1,5),GC_35,AMP(1))
      CALL VVV1P0_1(W(1,7),W(1,5),-GC_3,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,9),W(1,6),W(1,8),-GC_3,AMP(2))
      CALL VVS1_3(W(1,7),W(1,5),GC_72,MDL_MH,MDL_WH,W(1,10))
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,6),W(1,8),W(1,10),GC_72,AMP(3))
      CALL VVV1_3(W(1,7),W(1,5),GC_53,MDL_MZ,MDL_WZ,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,6),W(1,8),W(1,10),GC_53,AMP(4))
      CALL VVV1P0_1(W(1,6),W(1,5),-GC_3,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL VVV1_0(W(1,11),W(1,7),W(1,8),-GC_3,AMP(5))
      CALL VVS1_3(W(1,6),W(1,5),GC_72,MDL_MH,MDL_WH,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL VVS1_0(W(1,7),W(1,8),W(1,12),GC_72,AMP(6))
      CALL VVV1_3(W(1,6),W(1,5),GC_53,MDL_MZ,MDL_WZ,W(1,13))
C     Amplitude(s) for diagram number 7
      CALL VVV1_0(W(1,7),W(1,8),W(1,13),GC_53,AMP(7))
      CALL FFV2_1(W(1,3),W(1,6),GC_100,ZERO,ZERO,W(1,14))
      CALL FFV2_2(W(1,4),W(1,7),GC_100,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,15),W(1,14),W(1,5),GC_100,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,4),W(1,14),W(1,9),GC_1,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,4),W(1,14),W(1,10),GC_50,GC_58,AMP(10))
      CALL FFV2_2(W(1,4),W(1,6),GC_100,ZERO,ZERO,W(1,16))
      CALL FFV2_1(W(1,3),W(1,7),GC_100,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,16),W(1,17),W(1,5),GC_100,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,16),W(1,3),W(1,9),GC_2,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,16),W(1,3),W(1,10),-GC_50,GC_58,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,4),W(1,17),W(1,11),GC_1,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,15),W(1,3),W(1,11),GC_2,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,4),W(1,17),W(1,13),GC_50,GC_58,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_5_0(W(1,15),W(1,3),W(1,13),-GC_50,GC_58,AMP(17))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_2,ZERO,ZERO,W(1,15))
      CALL FFV1P0_3(W(1,4),W(1,2),GC_1,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 18
      CALL VVVV2_0(W(1,15),W(1,17),W(1,6),W(1,5),GC_5,AMP(18))
      CALL VVV1_2(W(1,15),W(1,5),-GC_3,MDL_MW,MDL_WW,W(1,10))
C     Amplitude(s) for diagram number 19
      CALL VVV1_0(W(1,17),W(1,6),W(1,10),-GC_3,AMP(19))
      CALL VVV1_3(W(1,15),W(1,6),-GC_3,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 20
      CALL VVV1_0(W(1,17),W(1,9),W(1,5),-GC_3,AMP(20))
      CALL FFV2_3_3(W(1,4),W(1,2),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 21
      CALL VVVV5_0(W(1,15),W(1,6),W(1,5),W(1,7),GC_57,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL VVV1_0(W(1,6),W(1,10),W(1,7),GC_53,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL VVV1_0(W(1,9),W(1,5),W(1,7),GC_53,AMP(23))
      CALL FFV2_5_3(W(1,1),W(1,3),-GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,18))
C     Amplitude(s) for diagram number 24
      CALL VVVV5_0(W(1,17),W(1,6),W(1,5),W(1,18),GC_57,AMP(24))
      CALL VVV1_1(W(1,5),W(1,18),GC_53,MDL_MW,MDL_WW,W(1,19))
C     Amplitude(s) for diagram number 25
      CALL VVV1_0(W(1,17),W(1,6),W(1,19),-GC_3,AMP(25))
      CALL VVV1_2(W(1,6),W(1,18),GC_53,MDL_MW,MDL_WW,W(1,20))
C     Amplitude(s) for diagram number 26
      CALL VVV1_0(W(1,17),W(1,20),W(1,5),-GC_3,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL VVVV2_0(W(1,6),W(1,5),W(1,18),W(1,7),GC_36,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL VVV1_0(W(1,6),W(1,19),W(1,7),GC_53,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL VVV1_0(W(1,20),W(1,5),W(1,7),GC_53,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL VVS1_0(W(1,18),W(1,7),W(1,12),GC_81,AMP(30))
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO,ZERO,W(1,12))
      CALL FFV1_2(W(1,4),W(1,15),GC_1,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 31
      CALL FFV2_0(W(1,21),W(1,12),W(1,6),GC_100,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_0(W(1,4),W(1,12),W(1,9),GC_100,AMP(32))
      CALL FFV2_3_2(W(1,4),W(1,18),GC_50,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 33
      CALL FFV2_0(W(1,9),W(1,12),W(1,6),GC_100,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV2_0(W(1,4),W(1,12),W(1,20),GC_100,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,16),W(1,12),W(1,15),GC_2,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV2_5_0(W(1,16),W(1,12),W(1,18),-GC_50,GC_58,AMP(36))
      CALL FFV1_1(W(1,2),W(1,15),GC_1,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 37
      CALL FFV2_0(W(1,16),W(1,20),W(1,5),GC_100,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV2_0(W(1,16),W(1,2),W(1,10),GC_100,AMP(38))
      CALL FFV2_3_1(W(1,2),W(1,18),GC_50,GC_58,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 39
      CALL FFV2_0(W(1,16),W(1,10),W(1,5),GC_100,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV2_0(W(1,16),W(1,2),W(1,19),GC_100,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,4),W(1,20),W(1,11),GC_1,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,21),W(1,2),W(1,11),GC_1,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV2_3_0(W(1,4),W(1,20),W(1,13),GC_50,GC_58,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV2_3_0(W(1,21),W(1,2),W(1,13),GC_50,GC_58,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,4),W(1,10),W(1,11),GC_1,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,9),W(1,2),W(1,11),GC_1,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV2_3_0(W(1,4),W(1,10),W(1,13),GC_50,GC_58,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV2_3_0(W(1,9),W(1,2),W(1,13),GC_50,GC_58,AMP(48))
...
C     Amplitude(s) for diagram number 49
      CALL VVV1_0(W(1,17),W(1,6),W(1,10),-GC_3,AMP(49))
      CALL FFV2_2(W(1,9),W(1,6),GC_100,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,21),W(1,3),W(1,17),GC_2,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL VVV1_0(W(1,6),W(1,10),W(1,7),GC_53,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV2_5_0(W(1,21),W(1,3),W(1,7),-GC_50,GC_58,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,9),W(1,14),W(1,17),GC_1,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV2_3_0(W(1,9),W(1,14),W(1,7),GC_50,GC_58,AMP(54))
      CALL FFV1P0_3(W(1,9),W(1,2),GC_1,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 55
      CALL VVV1_0(W(1,20),W(1,6),W(1,8),-GC_3,AMP(55))
      CALL FFV2_3_3(W(1,9),W(1,2),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,19))
C     Amplitude(s) for diagram number 56
      CALL VVV1_0(W(1,6),W(1,8),W(1,19),GC_53,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFV2_0(W(1,21),W(1,2),W(1,8),GC_100,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,4),W(1,14),W(1,20),GC_1,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV2_3_0(W(1,4),W(1,14),W(1,19),GC_50,GC_58,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,16),W(1,3),W(1,20),GC_2,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV2_5_0(W(1,16),W(1,3),W(1,19),-GC_50,GC_58,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV2_0(W(1,16),W(1,2),W(1,10),GC_100,AMP(62))
      CALL FFV1_2(W(1,1),W(1,17),GC_2,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 63
      CALL FFV2_0(W(1,10),W(1,14),W(1,5),GC_100,AMP(63))
      CALL FFV2_3(W(1,1),W(1,14),GC_100,MDL_MW,MDL_WW,W(1,19))
C     Amplitude(s) for diagram number 64
      CALL VVV1_0(W(1,17),W(1,19),W(1,5),-GC_3,AMP(64))
      CALL FFV2_5_2(W(1,1),W(1,7),-GC_50,GC_58,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 65
      CALL FFV2_0(W(1,20),W(1,14),W(1,5),GC_100,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL VVV1_0(W(1,19),W(1,5),W(1,7),GC_53,AMP(66))
C     Amplitude(s) for diagram number 67
      CALL FFV1_0(W(1,10),W(1,3),W(1,11),GC_2,AMP(67))
      CALL FFV1_2(W(1,1),W(1,11),GC_2,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 68
      CALL FFV1_0(W(1,5),W(1,3),W(1,17),GC_2,AMP(68))
C     Amplitude(s) for diagram number 69
      CALL FFV2_5_0(W(1,10),W(1,3),W(1,13),-GC_50,GC_58,AMP(69))
      CALL FFV2_5_2(W(1,1),W(1,13),-GC_50,GC_58,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 70
      CALL FFV1_0(W(1,10),W(1,3),W(1,17),GC_2,AMP(70))
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,20),W(1,3),W(1,11),GC_2,AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFV2_5_0(W(1,5),W(1,3),W(1,7),-GC_50,GC_58,AMP(72))
C     Amplitude(s) for diagram number 73
      CALL FFV2_5_0(W(1,20),W(1,3),W(1,13),-GC_50,GC_58,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV2_5_0(W(1,10),W(1,3),W(1,7),-GC_50,GC_58,AMP(74))
      CALL FFV1P0_3(W(1,1),W(1,12),GC_2,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 75
      CALL VVV1_0(W(1,7),W(1,6),W(1,8),-GC_3,AMP(75))
      CALL FFV2_5_3(W(1,1),W(1,12),-GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,20))
C     Amplitude(s) for diagram number 76
      CALL VVV1_0(W(1,6),W(1,8),W(1,20),GC_53,AMP(76))
      CALL FFV2_2(W(1,1),W(1,8),GC_100,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 77
      CALL FFV2_0(W(1,17),W(1,12),W(1,6),GC_100,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL FFV1_0(W(1,4),W(1,14),W(1,7),GC_1,AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFV2_3_0(W(1,4),W(1,14),W(1,20),GC_50,GC_58,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV2_0(W(1,4),W(1,12),W(1,19),GC_100,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,16),W(1,3),W(1,7),GC_2,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV2_5_0(W(1,16),W(1,3),W(1,20),-GC_50,GC_58,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,17),W(1,2),W(1,11),GC_1,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV2_0(W(1,5),W(1,2),W(1,8),GC_100,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV2_3_0(W(1,17),W(1,2),W(1,13),GC_50,GC_58,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV2_0(W(1,10),W(1,2),W(1,8),GC_100,AMP(86))

      
      JAMP(1)=-AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)-AMP(6)-AMP(7)-AMP(8)
     $ -AMP(9)-AMP(10)-AMP(11)-AMP(12)-AMP(13)-AMP(14)-AMP(15)-AMP(16)
     $ -AMP(17)-AMP(55)-AMP(56)-AMP(57)-AMP(58)-AMP(59)-AMP(60)-AMP(61)
     $ -AMP(75)-AMP(76)-AMP(77)-AMP(78)-AMP(79)-AMP(81)-AMP(82)-AMP(83)
     $ -AMP(84)-AMP(85)-AMP(86)
     ...
     $ +AMP(49)+AMP(50)+AMP(51)+AMP(52)+AMP(53)+AMP(54)+AMP(62)+AMP(63)
     $ +AMP(64)+AMP(65)+AMP(66)+AMP(67)+AMP(68)+AMP(69)+AMP(70)+AMP(71)
     $     +AMP(72)+AMP(73)+AMP(74)+AMP(80)
...
C      print*,AMP(1)
     ...
     $     +AMP(72)+AMP(73)+AMP(74)+AMP(80)
      ...
      if(ftype.eq.'RH')then
         if(nhel(1).eq.-1)matrix_udb=0d0 ! set to zero if LH
         if(nhel(2).eq.1)matrix_udb=0d0 ! set to zero if LH
      elseif(ftype.eq.'LH')then
         if(nhel(1).eq.1)matrix_udb=0d0 ! set to zero if RH
         if(nhel(2).eq.-1)matrix_udb=0d0 ! set to zero if RH
      ...
      elseif(wpol.eq.'tran')then
         if(nhel(6).eq.0)matrix_udb=0d0
         if(nhel(5).eq.0)matrix_udb=0d0
      elseif(wpol.eq.'long')then
         if(nhel(6).eq.1)matrix_udb=0d0
         if(nhel(5).eq.1)matrix_udb=0d0
         if(nhel(6).eq.-1)matrix_udb=0d0
         if(nhel(5).eq.-1)matrix_udb=0d0
      endif 
