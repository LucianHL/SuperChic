...
C     
      INTEGER USERHEL
      COMMON/HELUSERCHOICE_du/USERHEL
      DATA USERHEL/-1/
      LOGICAL HELRESET
      ...
      COMMON/BORN_BEAM_POL_du/POLARIZATIONS
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=MATRIX_DU(P ,NHEL(1,IHEL),JC(1))
     ...
     $        THEN
      ...
      REAL*8 FUNCTION MATRIX_DU(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.1.1, 2021-05-28
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_5_3(W(1,1),W(1,3),-GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,12))
...
C     Amplitude(s) for diagram number 13
      ...
      CALL FFV2_2(W(1,2),W(1,6),GC_100,ZERO,ZERO,W(1,16))
      CALL FFV1_1(W(1,4),W(1,7),GC_1,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,16),W(1,17),W(1,5),GC_100,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,16),W(1,4),W(1,9),GC_100,AMP(15))
      CALL FFV2_3_1(W(1,4),W(1,12),GC_50,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,16),W(1,9),W(1,5),GC_100,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,16),W(1,4),W(1,13),GC_100,AMP(17))
      CALL FFV2_1(W(1,4),W(1,5),GC_100,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,16),W(1,13),W(1,7),GC_2,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_5_0(W(1,16),W(1,13),W(1,12),-GC_50,GC_58,AMP(19))
      CALL FFV1_2(W(1,2),W(1,7),GC_1,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,18),W(1,13),W(1,6),GC_100,AMP(20))
...
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,18),W(1,4),W(1,14),GC_1,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,2),W(1,17),W(1,14),GC_1,AMP(25))
      CALL VVV1_3(W(1,6),W(1,5),GC_53,MDL_MZ,MDL_WZ,W(1,12))
C     Amplitude(s) for diagram number 26
      CALL FFV2_3_0(W(1,18),W(1,4),W(1,12),GC_50,GC_58,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV2_3_0(W(1,2),W(1,17),W(1,12),GC_50,GC_58,AMP(27))
...
C     Amplitude(s) for diagram number 31
      ...
      CALL FFV2_3(W(1,1),W(1,4),GC_100,MDL_MW,MDL_WW,W(1,9))
...
C     Amplitude(s) for diagram number 32
      ...
      CALL VVV1P0_1(W(1,9),W(1,5),-GC_3,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 33
      CALL VVV1_0(W(1,17),W(1,6),W(1,10),-GC_3,AMP(33))
      CALL VVS1_3(W(1,9),W(1,5),GC_72,MDL_MH,MDL_WH,W(1,18))
C     Amplitude(s) for diagram number 34
      CALL VVS1_0(W(1,6),W(1,10),W(1,18),GC_72,AMP(34))
      CALL VVV1_3(W(1,9),W(1,5),GC_53,MDL_MZ,MDL_WZ,W(1,18))
C     Amplitude(s) for diagram number 35
      CALL VVV1_0(W(1,6),W(1,10),W(1,18),GC_53,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL VVV1_0(W(1,14),W(1,9),W(1,10),-GC_3,AMP(36))
...
C     Amplitude(s) for diagram number 38
      ...
      CALL FFV2_1(W(1,3),W(1,9),GC_100,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 39
      CALL FFV2_0(W(1,16),W(1,15),W(1,5),GC_100,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,16),W(1,3),W(1,17),GC_2,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV2_5_0(W(1,16),W(1,3),W(1,18),-GC_50,GC_58,AMP(41))
      CALL FFV2_1(W(1,3),W(1,6),GC_100,ZERO,ZERO,W(1,7))
      CALL FFV2_2(W(1,2),W(1,9),GC_100,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 42
      CALL FFV2_0(W(1,19),W(1,7),W(1,5),GC_100,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,2),W(1,7),W(1,17),GC_1,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV2_3_0(W(1,2),W(1,7),W(1,18),GC_50,GC_58,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,19),W(1,3),W(1,14),GC_2,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,2),W(1,15),W(1,14),GC_1,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV2_5_0(W(1,19),W(1,3),W(1,12),-GC_50,GC_58,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV2_3_0(W(1,2),W(1,15),W(1,12),GC_50,GC_58,AMP(48))
      CALL FFV2_2(W(1,1),W(1,5),GC_100,ZERO,ZERO,W(1,15))
      CALL FFV1P0_3(W(1,15),W(1,4),GC_1,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 49
      CALL VVV1_0(W(1,19),W(1,6),W(1,10),-GC_3,AMP(49))
      CALL FFV2_3_3(W(1,15),W(1,4),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,18))
C     Amplitude(s) for diagram number 50
      CALL VVV1_0(W(1,6),W(1,10),W(1,18),GC_53,AMP(50))
      CALL FFV2_2(W(1,15),W(1,6),GC_100,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 51
      CALL FFV2_0(W(1,17),W(1,4),W(1,10),GC_100,AMP(51))
      CALL FFV2_3(W(1,15),W(1,3),GC_100,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 52
      CALL VVV1_0(W(1,8),W(1,6),W(1,9),-GC_3,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,17),W(1,3),W(1,8),GC_2,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL VVV1_0(W(1,6),W(1,9),W(1,11),GC_53,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV2_5_0(W(1,17),W(1,3),W(1,11),-GC_50,GC_58,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFV1_0(W(1,15),W(1,7),W(1,8),GC_1,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFV2_3_0(W(1,15),W(1,7),W(1,11),GC_50,GC_58,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV2_0(W(1,16),W(1,4),W(1,9),GC_100,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,16),W(1,3),W(1,19),GC_2,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV2_5_0(W(1,16),W(1,3),W(1,18),-GC_50,GC_58,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,2),W(1,7),W(1,19),GC_1,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV2_3_0(W(1,2),W(1,7),W(1,18),GC_50,GC_58,AMP(62))
      CALL FFV2_2(W(1,1),W(1,10),GC_100,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 63
      CALL FFV2_0(W(1,18),W(1,13),W(1,6),GC_100,AMP(63))
      CALL FFV1P0_3(W(1,1),W(1,13),GC_2,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 64
      CALL VVV1_0(W(1,19),W(1,6),W(1,10),-GC_3,AMP(64))
      CALL FFV2_5_3(W(1,1),W(1,13),-GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,9))
C     Amplitude(s) for diagram number 65
      CALL VVV1_0(W(1,6),W(1,10),W(1,9),GC_53,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL FFV1_0(W(1,18),W(1,4),W(1,14),GC_1,AMP(66))
      CALL FFV1_2(W(1,1),W(1,14),GC_2,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 67
      CALL FFV2_0(W(1,6),W(1,4),W(1,10),GC_100,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFV2_3_0(W(1,18),W(1,4),W(1,12),GC_50,GC_58,AMP(68))
      CALL FFV2_5_2(W(1,1),W(1,12),-GC_50,GC_58,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 69
      CALL FFV2_0(W(1,18),W(1,4),W(1,10),GC_100,AMP(69))
      CALL FFV1_2(W(1,1),W(1,8),GC_2,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 70
      CALL FFV2_0(W(1,10),W(1,7),W(1,5),GC_100,AMP(70))
      CALL FFV2_3(W(1,1),W(1,7),GC_100,MDL_MW,MDL_WW,W(1,4))
C     Amplitude(s) for diagram number 71
      CALL VVV1_0(W(1,8),W(1,4),W(1,5),-GC_3,AMP(71))
      CALL FFV2_5_2(W(1,1),W(1,11),-GC_50,GC_58,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 72
      CALL FFV2_0(W(1,15),W(1,7),W(1,5),GC_100,AMP(72))
C     Amplitude(s) for diagram number 73
      CALL VVV1_0(W(1,4),W(1,5),W(1,11),GC_53,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV1_0(W(1,10),W(1,3),W(1,14),GC_2,AMP(74))
C     Amplitude(s) for diagram number 75
      CALL FFV1_0(W(1,6),W(1,3),W(1,8),GC_2,AMP(75))
C     Amplitude(s) for diagram number 76
      CALL FFV2_5_0(W(1,10),W(1,3),W(1,12),-GC_50,GC_58,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,18),W(1,3),W(1,8),GC_2,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL FFV1_0(W(1,15),W(1,3),W(1,14),GC_2,AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFV2_5_0(W(1,6),W(1,3),W(1,11),-GC_50,GC_58,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV2_5_0(W(1,15),W(1,3),W(1,12),-GC_50,GC_58,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV2_5_0(W(1,18),W(1,3),W(1,11),-GC_50,GC_58,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,16),W(1,3),W(1,19),GC_2,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV2_5_0(W(1,16),W(1,3),W(1,9),-GC_50,GC_58,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV2_0(W(1,2),W(1,13),W(1,4),GC_100,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,2),W(1,7),W(1,19),GC_1,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV2_3_0(W(1,2),W(1,7),W(1,9),GC_50,GC_58,AMP(86))
     ...
     $ -AMP(80)-AMP(81)-AMP(84)
      ...
      if(ftype.eq.'RH')then
         if(nhel(1).eq.-1)matrix_du=0d0 ! set to zero if LH
         if(nhel(2).eq.-1)matrix_du=0d0 ! set to zero if LH
      elseif(ftype.eq.'LH')then
         if(nhel(1).eq.1)matrix_du=0d0 ! set to zero if RH
         if(nhel(2).eq.1)matrix_du=0d0 ! set to zero if RH
      ...
      elseif(wpol.eq.'tran')then
         if(nhel(6).eq.0)matrix_du=0d0
         if(nhel(5).eq.0)matrix_du=0d0
      elseif(wpol.eq.'long')then
         if(nhel(6).eq.1)matrix_du=0d0
         if(nhel(5).eq.1)matrix_du=0d0
         if(nhel(6).eq.-1)matrix_du=0d0
         if(nhel(5).eq.-1)matrix_du=0d0
      endif
