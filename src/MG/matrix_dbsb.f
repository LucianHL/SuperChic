...
C     
C     Process: d~ s~ > d~ s~ w+ w- QCD=0 @18
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      INTEGER USERHEL
      COMMON/HELUSERCHOICE_DBSB/USERHEL
      DATA USERHEL/-1/
      LOGICAL HELRESET_DBSB
      COMMON/HELRESET_DBSB/HELRESET_DBSB
      DATA HELRESET_DBSB/.TRUE./
      ...
      COMMON/BORN_BEAM_POL_DBSB/POLARIZATIONS
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=MATRIX_DBSB(P ,NHEL(1,IHEL),JC(1))
     ...
     $        THEN
      ...
      REAL*8 FUNCTION MATRIX_DBSB(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.1.1, 2021-05-28
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,3),W(1,1),GC_1,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_3_3(W(1,3),W(1,1),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,12))
...
C     Amplitude(s) for diagram number 13
      ...
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO,ZERO,W(1,15))
      CALL FFV1_2(W(1,4),W(1,7),GC_1,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,16),W(1,15),W(1,6),GC_100,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,4),W(1,15),W(1,10),GC_100,AMP(15))
      CALL FFV2_3_2(W(1,4),W(1,12),GC_50,GC_58,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,10),W(1,15),W(1,6),GC_100,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,4),W(1,15),W(1,14),GC_100,AMP(17))
      CALL FFV2_2(W(1,4),W(1,6),GC_100,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,14),W(1,15),W(1,7),GC_2,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_5_0(W(1,14),W(1,15),W(1,12),-GC_50,GC_58,AMP(19))
      CALL FFV1_1(W(1,2),W(1,7),GC_1,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,14),W(1,17),W(1,5),GC_100,AMP(20))
...
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,4),W(1,17),W(1,13),GC_1,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,16),W(1,2),W(1,13),GC_1,AMP(25))
      CALL VVV1_3(W(1,6),W(1,5),GC_53,MDL_MZ,MDL_WZ,W(1,12))
C     Amplitude(s) for diagram number 26
      CALL FFV2_3_0(W(1,4),W(1,17),W(1,12),GC_50,GC_58,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV2_3_0(W(1,16),W(1,2),W(1,12),GC_50,GC_58,AMP(27))
...
C     Amplitude(s) for diagram number 31
      ...
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO,ZERO,W(1,10))
      CALL FFV2_3(W(1,3),W(1,10),GC_100,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 32
      CALL VVV1_0(W(1,8),W(1,6),W(1,9),-GC_3,AMP(32))
      CALL FFV2_1(W(1,10),W(1,6),GC_100,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,3),W(1,16),W(1,8),GC_1,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL VVV1_0(W(1,6),W(1,9),W(1,11),GC_53,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV2_3_0(W(1,3),W(1,16),W(1,11),GC_50,GC_58,AMP(35))
      CALL FFV2_2(W(1,3),W(1,6),GC_100,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,16),W(1,10),W(1,8),GC_2,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV2_5_0(W(1,16),W(1,10),W(1,11),-GC_50,GC_58,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV2_0(W(1,14),W(1,2),W(1,9),GC_100,AMP(38))
      CALL FFV1_1(W(1,1),W(1,8),GC_1,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 39
      CALL FFV2_0(W(1,16),W(1,9),W(1,5),GC_100,AMP(39))
      CALL FFV2_3(W(1,16),W(1,1),GC_100,MDL_MW,MDL_WW,W(1,14))
C     Amplitude(s) for diagram number 40
      CALL VVV1_0(W(1,8),W(1,14),W(1,5),-GC_3,AMP(40))
      CALL FFV2_3_1(W(1,1),W(1,11),GC_50,GC_58,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 41
      CALL FFV2_0(W(1,16),W(1,2),W(1,5),GC_100,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL VVV1_0(W(1,14),W(1,5),W(1,11),GC_53,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,3),W(1,9),W(1,13),GC_1,AMP(43))
      CALL FFV1_1(W(1,1),W(1,13),GC_1,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,3),W(1,5),W(1,8),GC_1,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV2_3_0(W(1,3),W(1,9),W(1,12),GC_50,GC_58,AMP(45))
      CALL FFV2_3_1(W(1,1),W(1,12),GC_50,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,3),W(1,9),W(1,8),GC_1,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,3),W(1,2),W(1,13),GC_1,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV2_3_0(W(1,3),W(1,5),W(1,11),GC_50,GC_58,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,12),GC_50,GC_58,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV2_3_0(W(1,3),W(1,9),W(1,11),GC_50,GC_58,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV2_0(W(1,4),W(1,15),W(1,14),GC_100,AMP(51))
     ...
     $ -AMP(49)-AMP(50)-AMP(51)
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        MATRIX_DBSB = MATRIX_DBSB+DBLE(ZTEMP*DCONJG(JAMP(I)))
      ENDDO
      
      if(ftype.eq.'RH')then
         if(nhel(1).eq.1)matrix_dbsb=0d0 ! set to zero if LH                                                                                                 
         if(nhel(2).eq.1)matrix_dbsb=0d0 ! set to zero if LH                                                                                                 
      elseif(ftype.eq.'LH')then
         if(nhel(1).eq.-1)matrix_dbsb=0d0 ! set to zero if RH                                                                                                
         if(nhel(2).eq.-1)matrix_dbsb=0d0 ! set to zero if RH                                                                                                
      ...
      elseif(wpol.eq.'tran')then
         if(nhel(6).eq.0)matrix_dbsb=0d0
         if(nhel(5).eq.0)matrix_dbsb=0d0
      elseif(wpol.eq.'long')then
         if(nhel(6).eq.1)matrix_dbsb=0d0
         if(nhel(5).eq.1)matrix_dbsb=0d0
         if(nhel(6).eq.-1)matrix_dbsb=0d0
         if(nhel(5).eq.-1)matrix_dbsb=0d0
      endif
