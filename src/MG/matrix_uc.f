...
C
C     Process: u c > u c w+ w- QCD=0 @11
C
      IMPLICIT NONE
C
C     CONSTANTS
...
C
      INTEGER USERHEL
      COMMON/HELUSERCHOICE_uc/USERHEL
      DATA USERHEL/-1/
      LOGICAL HELRESET_UC
      COMMON/HELRESET_UC/HELRESET_UC
      DATA HELRESET_UC/.TRUE./
      ...
      COMMON/BORN_BEAM_POL_UC/POLARIZATIONS
...
C      only three external particles.
     ...
     $       -1.AND.(.NOT.IS_BORN_HEL_SELECTED(IHEL))) THEN
              CYCLE
            ENDIF
            T=MATRIX_UC(P ,NHEL(1,IHEL),JC(1))

c            print*,ihel,nhel(1,ihel),nhel(2,ihel),nhel(3,ihel)
c     &           ,nhel(4,ihel),nhel(5,ihel),nhel(6,ihel)
     ...
     $        THEN
      ...
      REAL*8 FUNCTION MATRIX_UC(P,NHEL,IC)
C
C     Generated by MadGraph5_aMC@NLO v. 3.1.1, 2021-05-28
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_5_3(W(1,2),W(1,4),-GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,11))
...
C     Amplitude(s) for diagram number 13
      ...
      CALL FFV2_2(W(1,2),W(1,5),GC_100,ZERO,ZERO,W(1,15))
      CALL FFV1_1(W(1,4),W(1,7),GC_2,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,15),W(1,16),W(1,6),GC_100,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,15),W(1,4),W(1,10),GC_100,AMP(15))
      CALL FFV2_5_1(W(1,4),W(1,12),-GC_50,GC_58,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,15),W(1,10),W(1,6),GC_100,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,15),W(1,4),W(1,14),GC_100,AMP(17))
      CALL FFV2_1(W(1,4),W(1,6),GC_100,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,15),W(1,14),W(1,7),GC_1,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_3_0(W(1,15),W(1,14),W(1,12),GC_50,GC_58,AMP(19))
      CALL FFV1_2(W(1,2),W(1,7),GC_2,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,17),W(1,14),W(1,5),GC_100,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_0(W(1,2),W(1,14),W(1,9),GC_100,AMP(21))
      CALL FFV2_5_2(W(1,2),W(1,12),-GC_50,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,9),W(1,14),W(1,5),GC_100,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,2),W(1,14),W(1,13),GC_100,AMP(23))
      CALL VVV1P0_1(W(1,6),W(1,5),-GC_3,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,17),W(1,4),W(1,13),GC_2,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,2),W(1,16),W(1,13),GC_2,AMP(25))
      CALL VVV1_3(W(1,6),W(1,5),GC_53,MDL_MZ,MDL_WZ,W(1,12))
C     Amplitude(s) for diagram number 26
      CALL FFV2_5_0(W(1,17),W(1,4),W(1,12),-GC_50,GC_58,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV2_5_0(W(1,2),W(1,16),W(1,12),-GC_50,GC_58,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,9),W(1,4),W(1,13),GC_2,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,2),W(1,10),W(1,13),GC_2,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_5_0(W(1,9),W(1,4),W(1,12),-GC_50,GC_58,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_5_0(W(1,2),W(1,10),W(1,12),-GC_50,GC_58,AMP(31))
      CALL FFV2_2(W(1,1),W(1,5),GC_100,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 32
      ...
      CALL FFV2_2(W(1,10),W(1,6),GC_100,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,16),W(1,3),W(1,8),GC_2,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL VVV1_0(W(1,6),W(1,9),W(1,11),GC_53,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV2_5_0(W(1,16),W(1,3),W(1,11),-GC_50,GC_58,AMP(35))
      CALL FFV2_1(W(1,3),W(1,6),GC_100,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,10),W(1,16),W(1,8),GC_1,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV2_3_0(W(1,10),W(1,16),W(1,11),GC_50,GC_58,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV2_0(W(1,2),W(1,14),W(1,9),GC_100,AMP(38))
      CALL FFV1_2(W(1,1),W(1,8),GC_2,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 39
      CALL FFV2_0(W(1,9),W(1,16),W(1,5),GC_100,AMP(39))
      CALL FFV2_3(W(1,1),W(1,16),GC_100,MDL_MW,MDL_WW,W(1,14))
C     Amplitude(s) for diagram number 40
      CALL VVV1_0(W(1,8),W(1,14),W(1,5),-GC_3,AMP(40))
      CALL FFV2_5_2(W(1,1),W(1,11),-GC_50,GC_58,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 41
      CALL FFV2_0(W(1,2),W(1,16),W(1,5),GC_100,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL VVV1_0(W(1,14),W(1,5),W(1,11),GC_53,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,9),W(1,3),W(1,13),GC_2,AMP(43))
      CALL FFV1_2(W(1,1),W(1,13),GC_2,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,5),W(1,3),W(1,8),GC_2,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV2_5_0(W(1,9),W(1,3),W(1,12),-GC_50,GC_58,AMP(45))
      CALL FFV2_5_2(W(1,1),W(1,12),-GC_50,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,9),W(1,3),W(1,8),GC_2,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,2),W(1,3),W(1,13),GC_2,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV2_5_0(W(1,5),W(1,3),W(1,11),-GC_50,GC_58,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFV2_5_0(W(1,2),W(1,3),W(1,12),-GC_50,GC_58,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV2_5_0(W(1,9),W(1,3),W(1,11),-GC_50,GC_58,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV2_0(W(1,15),W(1,4),W(1,14),GC_100,AMP(51))
     ...
     $ -AMP(49)-AMP(50)-AMP(51)
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        MATRIX_UC = MATRIX_UC+DBLE(ZTEMP*DCONJG(JAMP(I)))
      ENDDO

      if(ftype.eq.'RH')then
         if(nhel(1).eq.-1)matrix_uc=0d0 ! set to zero if LH
         if(nhel(2).eq.-1)matrix_uc=0d0 ! set to zero if LH
      elseif(ftype.eq.'LH')then
         if(nhel(1).eq.1)matrix_uc=0d0 ! set to zero if RH
         if(nhel(2).eq.1)matrix_uc=0d0 ! set to zero if RH
      ...
      elseif(wpol.eq.'tran')then
         if(nhel(6).eq.0)matrix_uc=0d0
         if(nhel(5).eq.0)matrix_uc=0d0
      elseif(wpol.eq.'long')then
         if(nhel(6).eq.1)matrix_uc=0d0
         if(nhel(5).eq.1)matrix_uc=0d0
         if(nhel(6).eq.-1)matrix_uc=0d0
         if(nhel(5).eq.-1)matrix_uc=0d0
      endif
