...
ccccccccccccccc
      ...
      COMPLEX*16 FUNCTION AMP_aaelel(P,NHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.20, 2024-06-17
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
ccccccccccccccccccccccc
            ...
            CALL OXXXXX(P(0,4),ZERO,NHEL(4),+1*IC(4),W(1,4))
              ...
              CALL FFV1_2_ll(W(1,3),W(1,1),-GC_3,ZERO,ZERO,W(1,5))
              CALL FFV1_0_ll(W(1,5),W(1,4),W(1,2),-GC_3,AMP(1))
              CALL FFV1_1_ll(W(1,4),W(1,1),-GC_3,ZERO,ZERO,W(1,5))
              CALL FFV1_0_ll(W(1,3),W(1,5),W(1,2),-GC_3,AMP(2))
