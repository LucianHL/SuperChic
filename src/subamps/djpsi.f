ccc   gg --> J/psi J/psi subprocess amplitude
      ...
      implicit none
      double precision sphi,cphi,sintp,s,rts,qf,phi
      double precision psi0,ppuu,pptt,pmuu,pmtt
      double precision mpuu,mptt,mmuu,mmtt,m
      double precision gampsi,denu,dent,cost,beta
      double precision alpha,u,t,mx,mu,alphas
