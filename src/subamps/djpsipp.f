ccc   gg --> psi(2S) psi(2S) subprocess amplitude
      ...
      implicit none
      double precision sphi,sintp,s,rts,qf,phi,cost,cphi
      double precision psi0,m,gampsip
      double precision denu,dent,beta
      double precision alpha,alphas,mx,u,t,mu
      double precision pptt,ppuu,pmuu,pmtt,mpuu,mptt,mmuu,mmtt
