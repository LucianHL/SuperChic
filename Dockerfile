...
RUN  yum -y  install  dnf-plugins-core \
                      ...
                      gcc-gfortran gcc-c++ bzip2 flang pythia8 pythia8-devel HepMC3 HepMC3-devel openssl-devel openssl && yum -y clean all &&  lhapdf update &&  lhapdf install MSHT20qed_nnlo && \
